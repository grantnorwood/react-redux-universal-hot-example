# opus.ui.student
The new v2 Student UI built using React.js.

---

## About

Seeded from the https://github.com/erikras/react-redux-universal-hot-example project by Erik Rasmussen, [@erikras](https://twitter.com/erikras).
